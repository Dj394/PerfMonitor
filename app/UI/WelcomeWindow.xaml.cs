...
namespace PerfMonitorLive.UI
{
    ...
    public partial class WelcomeWindow : Window
    {
        ...
        public WelcomeWindow(MachineInfo m, string alertScreen)
        {
            ...
            Point("🔔", "Alertes", "quand un seuil est dépassé assez longtemps, une notification apparaît " + (string.IsNullOrEmpty(alertScreen) ? "en bas à droite" : "sur " + alertScreen) + " avec des boutons d'action. Cliquer dessus ouvre la fenêtre. Réglable dans Paramètres.");
